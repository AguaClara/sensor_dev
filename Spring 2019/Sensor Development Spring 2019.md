...
## Abstract
The Sensor Development subteam’s goal is to develop low-cost sensors with readily available materials to monitor and report water quality in the water treatment processes in AguaClara plants and labs. In Spring 2019, the subteam worked on four different projects. The subteam started developing a calibration curve for the Fluidized Bed Solids Detector that was fabricated in the previous semester, and also prototyped a Sludge Blanket Detector for the upcoming Honduras trip. Additionally, the subteam finished developing the Mobile Application-Processed Endoscope. The subteam also started designing a low-cost turbidimeter that would measure both the transmittance and absorbance of light. 
