...
Our goal is to create low-cost water quality analyzing sensors for lab and field use. Two projects currently being developed are the sludge judge floc blanket meter and the low-cost turbidimeter. The basic function of this sensor is to relate absorbance or image values to concentrations.
